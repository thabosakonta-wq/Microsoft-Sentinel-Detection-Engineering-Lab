...
Analyst Workflow
Identify the PowerShell process.
Review the complete command line.
Examine the initiating process.
Identify the associated user account.
Check the device involved.
Correlate the activity with other endpoint or authentication events.
